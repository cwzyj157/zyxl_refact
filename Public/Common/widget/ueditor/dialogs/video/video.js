...
(function(){
    ...
    function createPreviewVideo(url){
		...
		if(conUrl.substr(conUrl.length-3).toLowerCase()=='flv'){
			$G("preview").innerHTML = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>'+
			'<object class id="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="' + 420  + '" height="' + 280  + '">' +
				'<param name="movie" value="/Public/Home/images/flvplayer.swf">'+
				'<param name="quality" value="high">'+
				'<param name="allowFullScreen" value="true">'+
				'<param name="FlashVars" value="vcastr_file=' + conUrl + '&LogoText=&BufferTime=3&IsAutoPlay=0">"'+
				'<embed src="/Public/Home/images/flvplayer.swf" allowfullscreen="true" flashvars="' + conUrl + '&LogoText=&IsAutoPlay=0" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="' + 420  + '" height="' + 280  + '"></embed>'+
			'</object>';
		}else{
			$G("preview").innerHTML = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>'+
